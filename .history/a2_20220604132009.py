...
pos_df = labelled_paragraphs_df.filter(labelled_paragraphs_df.label == "P").cache()
impossible_neg_df = labelled_paragraphs_df.filter(labelled_paragraphs_df.label == "impossible_N")
possible_neg_df = labelled_paragraphs_df.filter(labelled_paragraphs_df.label == "possible_N")
pos_df.show(20)
